...
import com.istudent.fragment.staff.AddMarksFragment;
import com.istudent.fragment.staff.AttendanceFragment;
import com.istudent.fragment.staff.ChangeStaffPasswordFragment;
import com.istudent.fragment.staff.StaffHomeFragment;
import com.istudent.fragment.student.ChangePasswordFragment;
import com.istudent.fragment.student.InternalMarksFragment;
import com.istudent.fragment.student.StudentAttendanceFragment;
...
public class StaffActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		navMenuTitles = getResources().getStringArray(
				R.array.nav_drawer_items_staff);

		// nav drawer icons from resources
		navMenuIcons = getResources().obtainTypedArray(
				R.array.nav_drawer_icons_staff);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId() == R.id.action_settings) {
			...
			Intent i = new Intent(StaffActivity.this, LoginActivity.class);
	...
	private void displayView(int position) {
		...
		case 3:
			fragment = new ChangeStaffPasswordFragment();
			fragment.setArguments(bundle);
			break;
		case 4:
			fragment = new InternalMarksFragment();
			fragment.setArguments(bundle);
			break;
		case 5:
		...
		if (fragment != null) {
			...
			Log.e("StaffActivity", "Error in creating fragment");
		}
