...
import com.istudent.fragment.student.CmritForum;
...
import com.istudent.fragment.student.StudentHomeFragment;
...
public class StudentActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		navMenuTitles = getResources().getStringArray(
				R.array.nav_drawer_items_student);

		// nav drawer icons from resources
		navMenuIcons = getResources().obtainTypedArray(
				R.array.nav_drawer_icons_student);
